          ...
          <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
            <div className="!visible mt-2 flex-grow basis-[100%] items-center lg:mt-0 lg:!flex lg:basis-auto">
              <ul className="navbar-nav md:flex pl-0 list-style-none mr-auto">
                ...
                <li className="nav-item mx-2"><a className="comforta nav-link text-white hover:main-color focus:text-blue-900 p-0 text-sm" href="#">Полиграфолог <span className="inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-600 text-white rounded ml-2">1</span></a></li>
                ...
                <li className="nav-item mx-2"><a className="nav-link text-white hover:main-color focus:text-blue-900 p-0 text-sm" href="#">Участие в конкурсе <span className="inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-600 text-white rounded ml-2">0</span></a></li>
                <li className="nav-item mx-2"><a className="comforta nav-link text-white hover:main-color focus:text-blue-900 p-0 text-sm" href="#">Согласование <span className="inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-600 text-white rounded ml-2">0</span></a></li>
                <li className="nav-item mx-2"><a className="comforta nav-link text-white hover:main-color focus:text-blue-900 p-0 text-sm" href="#">Подписанные <span className="inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-600 text-white rounded ml-2">3</span></a></li>
                <li className="nav-item mx-2"><a className="comforta nav-link text-white hover:main-color focus:text-blue-900 p-0 text-sm" href="#">Спецпроверка <span className="inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-600 text-white rounded ml-2">0</span></a></li>
