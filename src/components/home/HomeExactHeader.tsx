  ...
  return (
    <>
      ...
      <header
        id="header"
        className="header"
        style={{ position: "relative", overflow: "hidden", height: "200px", backgroundColor: "transparent" }}
      >
        <video
          autoPlay
          muted
        ...
        <div className="grid grid-cols-3 gap-4 w-full" style={{ position: "relative", zIndex: 1 }}>
